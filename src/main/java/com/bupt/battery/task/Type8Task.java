...
import com.bupt.battery.Enum.VDType;

import com.bupt.battery.entity.TaskDO;
import com.bupt.battery.entity.VoltageDifferenceDO;
...
public class Type8Task implements BaseTask {


    @Override
    public void excute(TaskDO taskDO,String request) {

//        TypeUtil.run(taskDO,request,"F:\\tmp8.py");
        TypeUtil.run(taskDO,request,"/home/python/type8.py");
